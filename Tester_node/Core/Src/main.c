...
int main(void)
{
  ...
  while (1)
  {
	 switch(tester_state) //change state
	 {
	 	...
	 	case READ_FIRSTFRAME: //through flow control to ecu in this state
	 	{
	 	...
	 	case CONSECUTTIVE_FRAME_READ:
	 	{
	 		//o trong day se kiem tra xem co bao nhieu goi can phai doc
	 		//sau khi het byte doc quay ve trang thai request read
	 		break;
	 	}
	 }
